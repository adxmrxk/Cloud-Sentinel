...
The dashboard scans the whole DynamoDB table on every request, which gets
slower and more expensive as audits accumulate. The rendered audit list is
cached here and invalidated whenever a new audit is ingested.
...
AUDITS_KEY = "cloudsentinel:audits:v1"
