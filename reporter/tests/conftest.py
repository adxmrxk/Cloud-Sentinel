...
os.environ.update(
    {
        ...
        # Deliver Slack alerts inline so tests can assert on the outcome;
        # test_notifier covers background delivery.
        "SLACK_DELIVERY": "sync",
...
def create_audits_table(with_index=True):
    extra = {}
    attributes = [
    ...
    if with_index:
        attributes.append({"AttributeName": "recordType", "AttributeType": "S"})
